# Identity Provider explainability notes

The `identity_provider` provider family explains what fixture evidence exists and how a caller should interpret it.
