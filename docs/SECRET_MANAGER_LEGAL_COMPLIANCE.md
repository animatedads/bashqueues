# Secret Manager legal and compliance notes

Fixture-first secret manager coverage is not live legal approval. These files are contract fixtures for documentation, static validation, and JSON shape testing.
