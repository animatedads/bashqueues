# Configuration Database legal and compliance notes
...
Regulated environments should require explicit approval before any future live-read package is enabled. Mutation remains out of scope for Bob14 service coverage.
