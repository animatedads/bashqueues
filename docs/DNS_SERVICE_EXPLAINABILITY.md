# DNS Service explainability

`dns_service` facts are deliberately advisory. They describe provider-family posture using fixture JSON so frontends and automated tools can explain what would be inspected without reaching live systems.
