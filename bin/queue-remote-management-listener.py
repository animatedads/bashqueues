...
DEFAULT_POLICY_FILE = "/etc/bashqueues/policies.d/remote-queue/remote-management.env"
DEFAULT_CLIENTS_FILE = "/etc/bashqueues/policies.d/remote-queue/clients.tsv"
DEFAULT_ACL_FILE = "/etc/bashqueues/policies.d/remote-queue/acl.tsv"
