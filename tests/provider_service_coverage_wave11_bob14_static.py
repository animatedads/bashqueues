...
for fam in ('backup_service', 'certificate_authority'):
...
assert service['next_candidates'] == ['license_manager', 'configuration_database']
print('PASS provider_service_coverage_wave11_bob14_static')
