...
fixtures = root / 'tests/fixtures/edge_cdn'
required = {'detect.json': 'queuebash.edge_cdn.detect.v1', 'distribution.json': 'queuebash.edge_cdn.distribution.v1', 'origin.json': 'queuebash.edge_cdn.origin.v1', 'cache.json': 'queuebash.edge_cdn.cache.v1', 'policy.json': 'queuebash.edge_cdn.policy.v1'}
for name_file, schema in required.items():
    ...
    assert obj['provider_family'] == 'edge_cdn', name_file
