...
[[ -f "$helper" ]]
bash -n "$helper"
[[ -f "docs/LOAD_BALANCER_PROVIDER_CONTRACTS.md" ]]
[[ -f "docs/LOAD_BALANCER_EXPLAINABILITY.md" ]]
[[ -f "docs/LOAD_BALANCER_LEGAL_COMPLIANCE.md" ]]
[[ -f "policies.d/load_balancer/default-policy.example.json" ]]
...
printf 'PASS load_balancer_provider_contracts_static
'
