...
fixtures = root / 'tests/fixtures/load_balancer'
required = {'detect.json': 'queuebash.load_balancer.detect.v1', 'balancer.json': 'queuebash.load_balancer.balancer.v1', 'listener.json': 'queuebash.load_balancer.listener.v1', 'target.json': 'queuebash.load_balancer.target.v1', 'health.json': 'queuebash.load_balancer.health.v1'}
for name_file, schema in required.items():
    ...
    assert obj['provider_family'] == 'load_balancer', name_file
