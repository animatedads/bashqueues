...
grep -q 'WIZARD_VERSION="0.18.11"' bin/queue-policy-wizard || fail 'wizard version not 0.18.11'
grep -q '^QUEUEBASH_VERSION="0.18.11"' queuebash.sh || fail 'queuebash version not 0.18.11'
