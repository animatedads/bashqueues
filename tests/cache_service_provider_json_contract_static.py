...
fixtures = root / 'tests/fixtures/cache_service'
required = {'detect.json': 'queuebash.cache_service.detect.v1', 'cluster.json': 'queuebash.cache_service.cluster.v1', 'endpoint.json': 'queuebash.cache_service.endpoint.v1', 'policy.json': 'queuebash.cache_service.policy.v1', 'metrics.json': 'queuebash.cache_service.metrics.v1'}
for name_file, schema in required.items():
    ...
    assert obj['provider_family'] == 'cache_service', name_file
