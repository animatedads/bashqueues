...
grep -q 'IBM Watson advisory provider' docs/IBM_CLOUD_GOVERNANCE.md || fail 'doc must keep Watson out of 0.18.11'
grep -q 'IBM HPCS key provider' docs/IBM_CLOUD_GOVERNANCE.md || fail 'doc must keep HPCS provider out of 0.18.11'
