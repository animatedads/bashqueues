...
grep -q 'Restriction Builder' "$repo_root/queuemgr_panel.py" || fail "manager missing restriction builder panel"
...
pass "panel manager includes panels, exceptions, and restriction variables"
echo
