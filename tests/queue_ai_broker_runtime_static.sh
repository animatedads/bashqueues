...
grep -q 'profile_health_policy' bin/queue-ai-broker || fail "broker profile health policy helper missing"
grep -q 'AI_ALLOWED_HEALTH_STATES' bin/queue-ai-broker || fail "broker profile health allow-list missing"
grep -q 'AI_BLOCKED_HEALTH_STATES' bin/queue-ai-broker || fail "broker profile health block-list missing"
grep -q 'health_summary' docs/QUEUE_AI_BROKER_HEALTH_CACHE.md || fail "health summary docs missing"
grep -q 'AI_ALLOWED_HEALTH_STATES' docs/QUEUE_AI_BROKER_HEALTH_CACHE.md || fail "profile health gate docs missing"
