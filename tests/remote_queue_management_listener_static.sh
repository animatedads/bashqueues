...
grep -q '/etc/queuebash/policies.d/remote-queue' install-system.sh || fail 'installer uses wrong remote policies.d path'
...
grep -q '/etc/queuebash/policies.d/remote-queue/remote-management.env' install-system.sh || fail 'installer completion message missing remote-management.env path'
grep -q '/etc/queuebash/policies.d/remote-queue/acl.tsv' install-system.sh || fail 'installer completion message missing acl.tsv path'
grep -q '/etc/queuebash/policies.d/remote-queue/clients.tsv' install-system.sh || fail 'installer completion message missing clients.tsv path'
