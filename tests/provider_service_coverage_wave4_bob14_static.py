...
for family in ['secret_manager', 'feature_store']:
    ...
    assert all(schema.startswith(f'queuebash.{family}.') for schema in fam['schemas']), family
...
print('PASS provider_service_coverage_wave4_bob14_static')
