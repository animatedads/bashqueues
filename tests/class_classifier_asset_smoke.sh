...
# The no_downgrade asset itself must not automatically block an unexplained model result.
...
rm -f /tmp/classifier_warn.out /tmp/classifier_near.out /tmp/classifier_cold.out /tmp/classifier_unexplained.out
